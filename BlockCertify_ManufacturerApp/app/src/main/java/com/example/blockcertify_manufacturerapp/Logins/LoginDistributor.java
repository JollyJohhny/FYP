...
public class LoginDistributor extends AppCompatActivity {
                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(LoginDistributor.this, "Welcome Distributor!",
                                        Toast.LENGTH_SHORT).show();

                                Intent intent = new Intent(LoginDistributor.this, ProfileDistributor.class);
                                startActivity(intent);

                            } else {
                                // If sign in fails, display a message to the user.
                                loadingDialog.dismiss();
                                Toast.makeText(LoginDistributor.this, "Invalid Login!",
                                        Toast.LENGTH_SHORT).show();
