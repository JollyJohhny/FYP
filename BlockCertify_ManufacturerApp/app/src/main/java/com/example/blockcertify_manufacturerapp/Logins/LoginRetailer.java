...
import com.example.blockcertify_manufacturerapp.Profiles.ProfileDistributor;
import com.example.blockcertify_manufacturerapp.Profiles.ProfileRetailer;
                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(LoginRetailer.this, "Welcome Retailer!",
                                        Toast.LENGTH_SHORT).show();

                                Intent intent = new Intent(LoginRetailer.this, ProfileRetailer.class);
                                startActivity(intent);

                            } else {
                                // If sign in fails, display a message to the user.
                                loadingDialog.dismiss();
                                Toast.makeText(LoginRetailer.this, "Invalid Login!",
                                        Toast.LENGTH_SHORT).show();
