...
public class RegisterShopkeeper extends AppCompatActivity {
    ...
    public void Register(View v){
        ...
        if(txtPassword.getText().toString().equals(txtCnfrmPwd.getText().toString())){
            ...
            flag = false;
            Toast.makeText(RegisterShopkeeper.this, "Password does not match!", Toast.LENGTH_SHORT).show();
        }
        ...
        if(flag == true){
            ...
            if(splitted.length >0){
                if(!splitted[1].equals("blockcertify.s.com")){
                    flag = false;

                    Toast.makeText(this, "Use blockcertify.s.com after @ to Register the Shopkeeper!",
                            Toast.LENGTH_LONG).show();
        ...
        if(flag){
            ...
            firebaseAuth.createUserWithEmailAndPassword(Email, Password)
                    .addOnCompleteListener(RegisterShopkeeper.this, new OnCompleteListener<AuthResult>() {
                        @Override
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                CreateNode();
                                loadingDialog.dismiss();
                                Toast.makeText(RegisterShopkeeper.this, "Shopkeeper Registered!", Toast.LENGTH_SHORT).show();


                                finish();
                            } else {
                                Toast.makeText(RegisterShopkeeper.this, "Shopkeeper already registered!", Toast.LENGTH_SHORT).show();
    ...
    public void CreateNode(){
        ...
        Partner p =new Partner(txtEmail.getText().toString(),"Shopkeeper");
